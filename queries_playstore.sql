...
SELECT category, COUNT(app_name) as count FROM analytics GROUP BY category HAVING COUNT(app_name) > 300;
or
...
SELECT app_name, min_installs, min_installs/reviews FROM analytics WHERE min_installs > 100000 LIMIT 1;
or 
