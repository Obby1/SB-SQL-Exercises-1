...
INSERT INTO products (name, price, can_be_returned) VALUES ('Lucky Charm', 0.99, 'False');
...
UPDATE products SET price = 29.00 WHERE name = 'Lucky Charm';
-- updated price of Lucky Charm to 29.00 as unable to have negative pricing on products
